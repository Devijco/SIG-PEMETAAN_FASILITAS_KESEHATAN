...
include_once "ambil_puskesmas.php";
...
$title = "Detail dan Lokasi : " . $nama_puskesmas;
?>
...
<script>
  function initialize() {
    ...
    var contentString = '<div id="content">' +
      '<div id="siteNotice">' +
      '</div>' +
      '<h1 id="firstHeading" class="firstHeading"><?php echo $nama_puskesmas ?></h1>' +
      '<div id="bodyContent">' +
      '<p><?php echo $alamat ?></p>' +
      '</div>' +
      '</div>';
  ...
  <div class="container">
    <div class="row d-flex align-items-center justify-content-center">
      <div class="about-content col-lg-12">
        <h1><b>
        Detail Informasi Geografis Puskesmas
        </b>
        </h1>
      </div>
    </div>
      ...
      <div class="col-md-7" data-aos="fade-up" data-aos-delay="200">
        <div class="panel panel-info panel-dashboard">
          <div class="panel-heading centered">
            <h2 style="font-size: large;" class="panel-title"><strong>Informasi Puskesmas </strong></h4>
          </div>
          <div class="panel-body">
            <table class="table">
              ...
              <tr>
                <td style="font-size: x-large;"><b>Nama Puskesmas</b></td>
                <td>
                  <h4><b><?php echo $nama_puskesmas ?></b></h4>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <?php if (!empty($item->foto)) : ?>
                    <img src="admin/gambar/<?php echo $item->foto; ?>" alt="Foto Puskesmas" style="max-width: 100px; max-height: 100px;" class="zoom">
                  <?php else : ?>
                    No Photo
                  <?php endif; ?>
                </td>
