            ...
            <div id="content">
                ...
                <div class="container-fluid" style="width: 550px; margin-right: 1200px;">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 style="color: black; font-weight: bold;" class="h3 mb-0"><b>Edit Data Tempat Rumah Sakit</b></h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            include '../koneksi.php';
                            $id = $_GET['id_rs'];
                            $query = mysqli_query($koneksi, "select * from rs where id_rs='$id'");
                            $data  = mysqli_fetch_array($query);
                            ?>

                            <!-- </div> -->
                            <div class="panel-body">
                                <form class="form-horizontal style-form" style="margin-top: 20px;" action="edit_aksi_rs.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return confirm('Yakin untuk mengedit?')">
                                    <div class="form-group" style="width: 700px;">
                                        <label style="font-weight: bold; color: black;" class="col-sm-2 col-sm-2 control-label"><b>ID Rumah Sakit</b></label>
                                        <div class="col-sm-8">
                                            <input style="font-weight: bold; color: black;" name="id_rs" type="text" id="id_rs" class="form-control" value="<?php echo $data['id_rs']; ?>" readonly />
                                    ...
                                    <div class="form-group" style="width: 700px;">
                                        ...
                                        <div class="col-sm-8">
                                            <input style="font-weight: bold; color: black;" name="nama_rs" type="text" id="nama_rs" class="form-control" value="<?php echo $data['nama_rs']; ?>" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <a onclick="return" class="btn btn-sm btn-danger" href="tampil_data_rs.php">Kembali</a>
                                        </div>
                                    </div>
                    ...
                    <div class="container-fluid" style="width: 650px; bottom: 945px; left: 500px; position: relative;">
                        <!-- Page Heading -->
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB8FQHJHpE0INbS5SHmVHXsLJX-gsXXnv0&callback=initMap&libraries=places&v=weekly" defer>
                                </script>
                            </div>
                        </div>
