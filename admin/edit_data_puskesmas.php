            ...
            <div id="content">
                ...
                <div class="container-fluid" style="width: 550px; margin-right: 1200px;">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 style="color: black; font-weight: bold;" class="h3 mb-0"><b>Edit Data Tempat Puskesmas</b></h1>
                    </div>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"><b>Edit Data</h6>
                        </div>
                        <div class="card-body">
                            ...
                            $query = mysqli_query($koneksi, "select * from puskesmas where id_puskesmas='$id'");
                            $data  = mysqli_fetch_array($query);
                            ?>

                            <!-- </div> -->
                            <div class="panel-body">
                                <form class="form-horizontal style-form" style="margin-top: 20px;" action="edit_aksi_puskesmas.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return confirm('Yakin untuk mengedit?')">
                                    <div class="form-group" style="width: 700px;">
                                        <label style="font-weight: bold; color: black;" class="col-sm-2 col-sm-2 control-label"><b>ID Puskesmas</b></label>
                                        <div class="col-sm-8">
                                            <input name="id_puskesmas" type="text" id="id_puskesmas" class="form-control" value="<?php echo $data['id_puskesmas']; ?>" readonly />
                                            <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                                        </div>
                                    </div>
                                    <div class="form-group" style="width: 700px;">
                                        <label style="font-weight: bold; color: black;" class="col-sm-2 col-sm-2 control-label"><b>Nama Puskesmas</b></label>
                                        <div class="col-sm-8">
                                            <input style="font-weight: bold; color: black;" name="nama_puskesmas" type="text" id="nama_puskesmas" class="form-control" value="<?php echo $data['nama_puskesmas']; ?>" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-bottom: 20px;">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <a onclick="return" class="btn btn-sm btn-danger" href="tampil_data_puskesmas.php">Kembali</a>
                                        </div>
                                    </div>
                    ...
                    <div class="container-fluid" style="width: 650px; bottom: 920px; left: 500px; position: relative;">
                    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
