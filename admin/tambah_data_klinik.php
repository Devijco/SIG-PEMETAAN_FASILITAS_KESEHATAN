    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                <div class="container-fluid" style="width: 500px; margin-right: 1200px; position: relative;">
                    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 style="color: black; font-weight: bold;" class="h3 mb-0"><b>Tambah Data Klinik</b></h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Main content -->
                            <form class="form-horizontal style-form" style="margin-top: 10px;" action="tambah_aksi_klinik.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return confirm('Yakin untuk menambahkan data?')">
                                <div class="form-group" style="width: 850px;">
                                    ...
                                    <div class="col-sm-6">
                                        <input style="font-weight: bold; color: black;" name="nama_klinik" type="text" class="form-control" placeholder="Nama Klinik" required />
                                    </div>
                                </div>
                                <div class="form-group" style="width: 850px;">
                ...
                <div class="container-fluid" style="width: 700px; bottom: 777px; left: 250px; position: relative;">
                    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
