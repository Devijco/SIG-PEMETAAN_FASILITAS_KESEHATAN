            ...
            <div id="content">
                ...
                <div class="container-fluid" style="width: 500px; margin-right: 1200px;">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 style="color: black; font-weight: bold;" class="h3 mb-0"><b>Tambah Data Puskemas</b></h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Main content -->
                            <form class="form-horizontal style-form" style="margin-top: 10px;" action="tambah_aksi_puskesmas.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return confirm('Yakin untuk menambahkan data?')">
                                <div class="form-group" style="width: 850px;">
                                    <label style="font-weight: bold; color: black;" class="col-sm-2 col-sm-2 control-label" ><b>Nama Puskemas</b></label>
                                    <div class="col-sm-6">
                                        <input style="font-weight: bold; color: black;" name="nama_puskesmas" type="text" class="form-control" placeholder="Nama Puskemas" required />
                                    </div>
                                </div>
                                <div class="form-group" style="width: 850px;">
